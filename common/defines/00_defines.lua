NDefines = {
    ...
    NCountry = {
        ...
        SPECIAL_FORCES_CAP_MIN = 64,					-- You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions 
